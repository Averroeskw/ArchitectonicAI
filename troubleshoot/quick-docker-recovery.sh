...
# Archie Docker Quick Recovery Script
# Use this when Archie gets stuck during Docker startup

echo "🚨 Archie Docker Quick Recovery"
echo "=============================="
echo ""
...
# Stop Archie containers
run_cmd "docker stop archie_python archie_comfyui archie_n8n" "Stopping Archie containers"

# Remove Archie containers
run_cmd "docker rm -f archie_python archie_comfyui archie_n8n" "Removing Archie containers"

# Remove Archie network
run_cmd "docker network rm archie_network" "Removing Archie network"
