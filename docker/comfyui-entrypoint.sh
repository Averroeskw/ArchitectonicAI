...
# ComfyUI Entrypoint Script for Archie
set -e

echo "🎨 Starting ComfyUI for Archie..."
...
# Archie ComfyUI Model Paths Configuration
archie:
    ...
    # Custom paths for Archie integration
...
# Start ComfyUI with Archie-optimized settings
