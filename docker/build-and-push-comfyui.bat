@echo off
echo 🎨 Building and Pushing ComfyUI Docker Container for Archie...
...
set "REPO_NAME=archie17verse/archie-comfyui"
...
if %errorlevel% equ 0 (
    ...
    echo.
    echo 🔗 Docker Hub: https://hub.docker.com/r/archie17verse/archie-comfyui
    echo.
