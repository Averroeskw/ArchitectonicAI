/**
 * Archie Flow SDK - Express.js Server Template
 * This template demonstrates how to deploy Archie workflows as REST APIs
 */
...
app.post('/validate', async (req, res) => {
  try {
    ...
    const testRunner = new ArchieFlowRunner({ enableLogging: false });
...
app.get('/info', (req, res) => {
  res.json({
    service: 'Archie Flow API Server',
    version: '2.0.0',
    sdk: 'archie-flow-sdk@2.0.0',
    features: [
      'Workflow execution',
      'Batch processing',
      'Custom nodes',
...
// Start server
app.listen(port, () => {
  console.log(`🚀 Archie Flow API Server running on port ${port}`);
  console.log(`📖 API Documentation: http://localhost:${port}/info`);
  console.log(`💚 Health Check: http://localhost:${port}/health`);
  console.log(`📊 Ready to execute Archie workflows!`);
});
