...
/**
 * Test Archie Flow SDK with Agent Studio Export Format
 * 
...
import { ArchieFlowRunner } from './dist/index.esm.js';
import fs from 'fs';
...
async function testExportCompatibility() {
  ...
  try {
    // Create a mock Agent Studio export in the archie-sdk format
