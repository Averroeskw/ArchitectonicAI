...
/**
 * Simple test for new Archie Flow SDK nodes
 * Tests node executors directly without complex flow validation
 */

import { ArchieFlowRunner } from './src/index.js';

console.log('[INFO] Testing new Archie Flow SDK nodes (direct execution)...');
...
async function runAllTests() {
  try {
    ...
    console.log('[INFO] Archie Flow SDK v1.4.0 with new nodes is ready for release');
    console.log('\n📦 New Features Added:');
