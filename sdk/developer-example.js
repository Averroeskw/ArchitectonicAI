/**
 * Archie Flow SDK v2.0 - Super Simple Developer Example
...
console.log('🧠 Archie Flow SDK - Developer-Friendly Example\n');

// Just import your workflow JSON (from Archie Studio export)
const myWorkflow = {
...
async function demonstrateSimpleUsage() {
  ...
  console.log('');
  console.log('1️⃣  Import your workflow JSON (from Archie Studio)');
  console.log('2️⃣  Create runner: const runner = new ArchieFlowRunner()');
