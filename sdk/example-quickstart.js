...
const result = await runner.execute(workflow, {
  greeting: 'Welcome',
  name: 'Archie SDK v2.0!'
});

console.log('\n🎉 Result:', result.result?.output || result['result']?.output);
console.log('\n✨ That\'s it! Your first Archie workflow is complete.');
