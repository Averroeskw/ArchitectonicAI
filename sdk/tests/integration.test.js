/**
 * Archie Flow SDK - Integration Tests
 */

import { ArchieFlowRunner } from '../src/index.js';

describe('Archie Flow SDK Integration Tests', () => {
  let runner;

  beforeEach(() => {
    runner = new ArchieFlowRunner({
  ...
  describe('Error Handling', () => {
    test('should handle execution timeout', async () => {
      const timeoutRunner = new ArchieFlowRunner({
        enableLogging: false,
  ...
  describe('Logging', () => {
    test('should capture execution logs when enabled', async () => {
      const loggingRunner = new ArchieFlowRunner({
        enableLogging: true,
        logLevel: 'debug'
      });
    ...
    test('should support different log levels', () => {
      const debugRunner = new ArchieFlowRunner({
        enableLogging: true,
        logLevel: 'debug'
      });

      const errorRunner = new ArchieFlowRunner({
        enableLogging: true,
        logLevel: 'error'
      });
  ...
  describe('Configuration', () => {
    test('should respect custom timeout settings', async () => {
      const customRunner = new ArchieFlowRunner({
        timeout: 2000,
        enableLogging: false
      });
    ...
    test('should handle sandbox configuration', () => {
      const sandboxedRunner = new ArchieFlowRunner({
        sandbox: true
      });

      const unsandboxedRunner = new ArchieFlowRunner({
        sandbox: false
      });
