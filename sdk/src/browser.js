/**
 * Browser-compatible entry point for Archie Flow SDK
 * Excludes Node.js-specific modules and provides browser-safe functionality
 */

// Import core functionality
import { ArchieFlowRunner } from './index.js';
...
class BrowserArchieFlowRunner extends ArchieFlowRunner {
  constructor(options = {}) {
...
export { BrowserArchieFlowRunner as ArchieFlowRunner };

// Also export utility functions
export const createFlowRunner = (options = {}) => {
  return new BrowserArchieFlowRunner(options);
};

export const validateFlow = (flowData) => {
  const runner = new BrowserArchieFlowRunner();
...
// Default export
export default BrowserArchieFlowRunner; 