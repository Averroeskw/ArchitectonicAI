...
export interface ArchieFlowRunnerOptions extends FlowExecutorOptions {
  // Additional SDK-specific options can be added here
}

export class ArchieFlowRunner {
  private executor: FlowExecutor;
  private customNodes: any[] = [];

  constructor(options: ArchieFlowRunnerOptions = {}) {
    this.executor = new FlowExecutor(options);
  }

  /**
   * Execute a flow from exported Archie Studio data
   */
