/**
 * Archie Flow SDK v2.0 - Modern AI Workflow Execution Engine
 * Zero-config SDK for running Archie AI agent workflows
 */

// Core execution engine
class ArchieFlowRunner {
  constructor(options = {}) {
    this.config = {
    ...
    if (this.config.enableLogging) {
      this.log('Archie Flow SDK v2.0 initialized');
    }
  }

  /**
   * Execute a workflow with inputs
   * @param {Object} flowData - Exported workflow from Archie Studio
  ...
  normalizeFlow(flowData) {
    // Handle different export formats from Archie Studio
  ...
  log(message, level = 'info', data = null) {
    ...
    if (typeof console !== 'undefined') {
      ...
      logMethod(`[Archie SDK] ${message}`, data || '');
    }
  }
}
...
export { ArchieFlowRunner, BrowserUtils };

// Default export for CommonJS compatibility
export default ArchieFlowRunner;