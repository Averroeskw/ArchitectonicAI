...
/**
 * Archie Flow SDK - Node.js Example
 * 
 * This example demonstrates how to load and execute a Archie flow
 * in a Node.js environment using the SDK.
 */

const { ArchieFlowRunner } = require('../dist/archie-flow-sdk.cjs.js');
const fs = require('fs');
const path = require('path');

async function runExample() {
  console.log('🚀 Archie Flow SDK - Node.js Example\n');
  ...
  try {
    ...
    const inputs = {
      'Text Input': 'Hello, Archie Flow SDK!'
    };
