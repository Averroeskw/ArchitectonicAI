/**
 * Archie Agent Studio - Node Generator
 * 
 ...
 * 
 * Generated by Archie Agent Studio Node Generator
 */
...
`;
  ...
  private generateManifest(nodeDefinition: any): any {
    return {
      name: `@archie/node-${nodeDefinition.type}`,
      version: '1.0.0',
      description: nodeDefinition.description,
      main: 'index.js',
      types: 'index.d.ts',
      keywords: ['archie', 'agent-studio', 'node', nodeDefinition.category],
      author: nodeDefinition.author || 'Archie Studio',
      license: 'MIT',
      peerDependencies: {
        '@archie/agent-studio': '^2.0.0',
        'react': '^18.0.0',
        'reactflow': '^11.0.0'
      },
      files: [
...
nodes for the Archie Agent Studio visual workflow system.
