...
export const DEFAULT_CONFIG = {
  ...
  hotReload: true,
  debugMode: false,
  pluginDirectories: ['./plugins', './node_modules/@archie/agent-studio-*'],
...
export const FILE_EXTENSIONS = {
  FLOW: '.archie-flow',
  PLUGIN: '.archie-plugin',
  TEMPLATE: '.archie-template',
  NODE: '.archie-node'
} as const;
