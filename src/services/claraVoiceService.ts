import { ArchieMessage, ArchieAIConfig } from '../types/archie_assistant_types';
...
/**
 * Archie Voice Service - Simplified for transcription only
 * This service only handles speech-to-text transcription as an accessibility feature
 */
export class ArchieVoiceService {
...
export const archieVoiceService = new ArchieVoiceService();