...
import type { ArchieProvider, ArchieModel, ArchieProviderType } from '../types/archie_assistant_types';
import { db } from '../db';

export class ArchieProviderService {
  private currentProvider: ArchieProvider | null = null;
   ...
   */
  public updateProvider(provider: ArchieProvider) {
  ...
  public async getProviders(): Promise<ArchieProvider[]> {
    try {
      ...
      const archieProviders: ArchieProvider[] = dbProviders.map(provider => ({
        id: provider.id,
        name: provider.name,
        type: provider.type as ArchieProviderType,
  ...
  public async getPrimaryProvider(): Promise<ArchieProvider | null> {
    try {
      ...
      return {
        ...
        type: dbProvider.type as ArchieProviderType,
...
export const archieProviderService = new ArchieProviderService(); 