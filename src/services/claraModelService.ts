...
export class ArchieModelService {
  /**
   ...
   */
  public isLocalProvider(config: ArchieAIConfig, baseUrl?: string): boolean {
...
export const archieModelService = new ArchieModelService(); 