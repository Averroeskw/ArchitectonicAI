...
class ArchieMemoryService {
  private static instance: ArchieMemoryService;
  private readonly MEMORY_KEY = 'archie-temp-memory';
  ...
  public static getInstance(): ArchieMemoryService {
    if (!ArchieMemoryService.instance) {
      ArchieMemoryService.instance = new ArchieMemoryService();
    }
    return ArchieMemoryService.instance;
  }
...
export const archieMemoryService = ArchieMemoryService.getInstance(); 