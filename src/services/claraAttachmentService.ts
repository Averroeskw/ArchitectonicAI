/**
 * Archie Attachment Service
 * Handles file attachment processing and analysis
 */

import { ArchieFileAttachment } from '../types/archie_assistant_types';

export class ArchieAttachmentService {
  /**
   * Process file attachments by analyzing them locally
   */
  public async processFileAttachments(attachments: ArchieFileAttachment[]): Promise<ArchieFileAttachment[]> {
   ...
   */
  public extractImageAttachments(attachments: ArchieFileAttachment[]): string[] {
    return attachments
   ...
   */
  public hasImages(attachments: ArchieFileAttachment[]): boolean {
   ...
   */
  public hasCodeFiles(attachments: ArchieFileAttachment[]): boolean {
   ...
   */
  public getAttachmentSummary(attachments: ArchieFileAttachment[]): string {
   ...
   */
  public validateAttachment(attachment: ArchieFileAttachment): { valid: boolean; error?: string } {
    if (!attachment.name) {
   ...
   */
  public filterValidAttachments(attachments: ArchieFileAttachment[]): ArchieFileAttachment[] {
...
export const archieAttachmentService = new ArchieAttachmentService(); 