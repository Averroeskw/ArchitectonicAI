...
const INITIAL_PLANNING_SYSTEM_PROMPT = `You are Archie's strategic planning module. Before executing any tools, you must analyze the project structure and create a comprehensive execution plan.
...
const REFLECTION_PLANNING_SYSTEM_PROMPT = `You are Archie's reflection and adaptation module. After each tool execution, you must analyze the results and plan the next steps.
...
const SYSTEM_PROMPT = `You are Archie, an expert AI assistant and exceptional senior software developer with vast knowledge across multiple programming languages, frameworks, and best practices. You are a Bolt-like AI agent that works automatically using the provided tools.
    ...
    <div className="h-full flex flex-col glassmorphic">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-none p-4 space-y-4">
        ...
        <TypingIndicator 
          ...
          message={currentTask || 'Archie is thinking...'}
        />
