...
// Import Archie Flow SDK
import { ArchieFlowRunner } from '../../sdk/src/ArchieFlowRunner';
...
const AgentRunnerSDK: React.FC<AgentRunnerProps> = ({ agentId, onClose }) => {
  ...
  const convertToSDKFormat = (agentFlow: any): any => {
    // Convert AgentBuilder format to Archie Flow SDK format
    return {
      format: 'archie-sdk',
      version: '1.0.0',
      flow: {
  ...
  const handleRunAgent = async () => {
    ...
    console.log('🚀 STARTING AGENT EXECUTION - Archie Flow SDK Approach');
    console.log('📋 Agent Flow:', agentFlow);
    console.log('📥 Input Values:', inputValues);

    try {
      // 🆕 Create Archie Flow SDK Runner - completely isolated
      const runner = new ArchieFlowRunner({
        enableLogging: true,
        timeout: 30000
      });

      console.log('✅ Archie Flow SDK Runner created');
      ...
      // 🎯 Execute using Archie Flow SDK - COMPLETELY ISOLATED
      console.log('⚡ Executing flow with Archie Flow SDK...');
      ...
      console.error('❌ Archie Flow SDK execution failed:', error);
        ...
        {showLogs && (
          <div className="mt-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-semibold text-gray-800 dark:text-gray-100">Archie Flow SDK Logs</h4>
      ...
      <div className="flex-1 flex overflow-hidden">
            ...
            >
              {isLoading ? (
                <div className="flex items-center justify-center gap-2">
                  ...
                  Executing with Archie Flow SDK...
                </div>
              ) : (
        ...
        <div className="flex-1 bg-white dark:bg-gray-800 flex flex-col">
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              View the output from your agent execution using Archie Flow SDK
            </p>
          </div>
