...
const Settings = () => {
  ...
  const updateFeatureConfig = async (updates: Partial<typeof featureConfig>) => {
    try {
      ...
      // Archie Core is always enabled
      newConfig.archieCore = true;
  ...
  useEffect(() => {
    if (effectiveActiveTab === 'api' && !providersLoading) {
      // Only auto-detect if no providers exist or only Archie's Core exists
      const nonCoreProviders = providers.filter(p => p.type !== 'archies-pocket');
  ...
  const handleAddProvider = async () => {
    try {
      ...
      if (error instanceof Error && error.message.includes("Archie's Pocket provider already exists")) {
        alert("⚠️ Archie's Pocket provider already exists. Only one instance is allowed.");
      } else {
  ...
  const getDefaultProviderConfig = (type: Provider['type']) => {
    switch (type) {
      ...
      case 'archies-pocket':
        return { baseUrl: 'http://localhost:8091/v1', name: "Archie's Core" };
      default:
        return { baseUrl: '', name: '' };
    }
  };
  ...
  const updateLlamacppBinaries = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.log('Official Llama.cpp Binaries Updated:', result.message || `Successfully updated official binaries to version ${result.version}. Archie's custom binaries were preserved.`);
      } else {
                        ...
                        <button
                          onClick={() => {
                            ...
                            const samples = [
                              ...
                              "This is a longer sample text to demonstrate how your typography settings affect readability in extended conversations with Archie.",
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <div>
                            <p className="text-gray-800 dark:text-gray-200 font-semibold text-sm">Archie</p>
                        ...
                        <p 
                          ...
                          data-preview-text
                        >
                          The quick brown fox jumps over the lazy dog. This preview demonstrates how your typography settings affect readability and visual appeal in conversations with Archie.
                        </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-2">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        Start ArchieVerse automatically when system boots
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
            ...
            <div className="glassmorphic rounded-xl p-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-lg p-6 mb-6">
                ...
                <p className="text-purple-700 dark:text-purple-300 mb-4">
                  Transform your Archie flows into ready-to-use JavaScript modules that can be directly integrated into any application using the Archie Flow SDK.
                </p>
              ...
              <div className="mb-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                  <ol className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
                    ...
                    <li><strong>5.</strong> Install the SDK: <code className="bg-blue-100 dark:bg-blue-900/50 px-2 py-1 rounded">npm install archie-flow-sdk</code></li>
            ...
            <div className="glassmorphic rounded-xl p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Keep Archie up to date with the latest features and improvements
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Archie {updateInfo?.currentVersion || '1.0.0'} on {updateInfo ? getPlatformName(updateInfo.platform) : 'Unknown Platform'}
                    </p>
                  </div>
                  <button
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">
                            New Version Available: Archie {updateInfo.latestVersion || 'Unknown'}
                          </h4>
                          ...
                          {updateInfo.isOTASupported ? (
                            <div className="space-y-3">
                              <p className="text-sm text-blue-700 dark:text-blue-300">
                                🍎 Automatic updates are supported on macOS. Click "Download & Install" to update Archie automatically.
                              </p>
                              <div className="flex gap-3">
                                <button
                                  onClick={handleManualUpdateCheck}
                    ...
                    <div className="bg-green-50/50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700 dark:text-green-300">
                            Archie {updateInfo.currentVersion || 'Unknown'} is the latest version.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Keep official llama.cpp inference binaries up to date (Archie's custom binaries are preserved)
                    </p>
                  </div>
                </div>
