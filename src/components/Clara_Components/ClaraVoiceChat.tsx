...
interface ArchieVoiceChatProps {
  isEnabled: boolean;
  onToggle: () => void;
...
const ArchieVoiceChat: React.FC<ArchieVoiceChatProps> = ({
  isEnabled,
  onToggle,
  onSendAudio,
  onReceiveAudio,
  ...
  useEffect(() => {
    const processAutoTTS = async () => {
      ...
      try {
        ...
        await archieTTSService.synthesizeAndPlay({
          text: cleanContent,
          engine: 'kokoro',
          voice: 'af_sarah',
          speed: 1.0,
...
export default ArchieVoiceChat; 