...
import { ArchieChatSession } from '../../types/archie_assistant_types';

interface ArchieSidebarProps {
...
const ArchieSidebar: React.FC<ArchieSidebarProps> = ({
  sessions = [],
  currentSessionId,
  isLoading = false,
  isLoadingMore = false,
  ...
  const getMessageCount = (session: ArchieChatSession) => {
  ...
  const getLastMessagePreview = (session: ArchieChatSession) => {
