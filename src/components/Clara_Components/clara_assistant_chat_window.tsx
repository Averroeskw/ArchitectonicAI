/**
 * Archie Assistant Chat Window Component
 * 
 * This component serves as the main chat interface for the Archie assistant.
...
import { 
  ArchieMessage, 
  ArchieChatWindowProps,
  ArchieProcessingState
} from '../../types/archie_assistant_types';
import ArchieMessageBubble from './archie_assistant_message_bubble';
      ...
      <div className="max-w-2xl text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
            Welcome{userName ? ` back, ${userName}` : ''} to Archie! 
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          <p>
            🔄 Archie automatically detects file types and uses the best AI models for each task.
          </p>
        </div>
      </div>
    </div>
...
/**
 * Loading screen component displayed when Archie is initializing
 */
...
const ProcessingIndicator: React.FC<{
  processingState: ArchieProcessingState;
  message?: string;
    ...
    switch (processingState) {
      case 'processing':
        return {
          ...
          text: message || 'Archie is thinking...',
          bgColor: 'bg-blue-500'
        };
      case 'success':
        return {
...
/**
 * Main Archie Chat Window Component
 */
const ArchieChatWindow: React.FC<ArchieChatWindowProps> = ({
  messages,
  userName,
  isLoading = false,
  ...
  const [processingState, setProcessingState] = useState<ArchieProcessingState>('idle');
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        {/* Loading screen when Archie is initializing */}
        {isInitializing ? (
...
export default ArchieChatWindow; 