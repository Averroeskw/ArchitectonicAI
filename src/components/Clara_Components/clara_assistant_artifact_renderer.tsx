/**
 * Archie Assistant Artifact Renderer
 * 
 * This component handles rendering of various artifact types generated by Archie,
...
export type EnhancedArtifactType = ArchieArtifactType | 
 ...
 */
const InteractiveChartRenderer: React.FC<{ content: string; artifact: ArchieArtifact; onFullScreen?: () => void }> = ({ content, artifact, onFullScreen }) => {
...
/**
 * Main Archie Artifact Renderer Component
 */
const ArchieArtifactRenderer: React.FC<ArchieArtifactRendererProps> = ({
  artifact,
  isExpanded = false,
  onToggleExpanded,
  onCopy,
  ...
  const getContentType = (type: ArchieArtifactType): string => {
    const types = {
      code: 'text/plain',
      html: 'text/html',
  ...
  const getFileExtension = (type: ArchieArtifactType): string => {
    const extensions = {
...
export default ArchieArtifactRenderer; 