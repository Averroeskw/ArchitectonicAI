    ...
    pages: {
      ...
      items: {
        ...
        properties: {
          ...
          content: {
            type: "string",
            description: "Complete HTML document with Archie's font, Tailwind CSS, Font Awesome, inline CSS, and inline JavaScript"
          },
          description: {
            type: "string",
...
export class AITemplateGenerator {
  ...
  private createSystemPrompt(): string {
    return `You are Archie's AI Template Generator, an expert web developer specializing in creating stunning, production-ready web applications that rival the best modern websites.
...
- Use Archie's Quicksand font family: https://fonts.googleapis.com/css2?family=Quicksand:wght@400;500;600;700&display=swap
- Implement Archie's sakura pink theme with dark mode design (gray-900, gray-800 backgrounds)
...
- Inline CSS within <style> tags for custom animations and Archie's design system
...
5. **Archie's Design System** - Quicksand font, sakura theme, dark mode, glassmorphic effects
...
- Professional color scheme using Archie's sakura palette
