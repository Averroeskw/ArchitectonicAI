...
export default defineConfig({
  ...
  const setupLanguageService = useCallback(async (monacoInstance: typeof monaco) => {
    ...
    try {
      ...
      // Add DOM types
      const domTypes = `
dearchie var document: Document;
dearchie var window: Window;
dearchie var console: Console;
dearchie var localStorage: Storage;
dearchie var sessionStorage: Storage;
dearchie var fetch: (input: RequestInfo, init?: RequestInit) => Promise<Response>;
