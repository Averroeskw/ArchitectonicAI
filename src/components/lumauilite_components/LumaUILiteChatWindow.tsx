...
Now executing plan systematically...`,
  ...
  const handleAutoModeExecution = async (userQuery: string) => {
    try {
      ...
      const baseAutoPrompt = customSystemPrompt || `You are Archie, an expert AI coding assistant with comprehensive tool access. Execute the user's request systematically using your available functions.`;
