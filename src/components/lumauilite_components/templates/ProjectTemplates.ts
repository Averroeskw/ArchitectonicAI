...
// Each template includes HTML, CSS, and JavaScript with Archie's font and stunning designs
...
// Archie's custom font CSS with sakura theme
const ARCHIE_FONT_CSS = `
@import url('https://fonts.googleapis.com/css2?family=Quicksand:wght@400;500;600;700&display=swap');

:root {
  --archie-font: 'Quicksand', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
  --sakura-50: #fdf2f8;
  --sakura-100: #fce7f3;
  --sakura-200: #fbcfe8;
  --sakura-300: #f9a8d4;
    ...
    <footer class="bg-gray-900/50 backdrop-blur-md border-t border-gray-700/50 py-12">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <div class="flex justify-center items-center mb-4">
                ...
                <span class="text-white">Built with Archie's LumaUI-lite</span>
                <i class="fas fa-heart text-sakura-400 mx-2"></i>
            </div>
