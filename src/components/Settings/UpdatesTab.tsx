                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-orange-100/60 dark:bg-orange-900/30 rounded-lg p-3 text-sm">
                        ...
                        <p className="text-orange-700 dark:text-orange-300 mt-1">
                          <strong>🔒 What stays untouched:</strong> Archie's custom binaries (llama-swap and others)
                        </p>
                      </div>
        ...
        <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
              <div>
                <strong>Archie's Custom Binaries:</strong> llama-swap and other Archie-specific tools remain untouched and preserved.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
