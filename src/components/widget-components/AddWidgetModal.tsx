...
const AVAILABLE_WIDGETS: WidgetOption[] = [
  {
    ...
    type: 'welcome',
    name: 'Welcome',
    description: 'Introduction and quick actions for Archie',
    ...
    preview: (
      <div className="p-3 bg-gray-500/5 dark:bg-gray-300/5 rounded-lg">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium text-gray-900 dark:text-white">Welcome to Archie</h3>
        </div>
  ...
  },
  {
    ...
    type: 'privacy',
    name: 'Privacy Notice',
    description: 'Information about Archie\'s privacy and security',
    ...
    preview: (
      <div className="p-3 bg-gray-500/5 dark:bg-gray-300/5 rounded-lg">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-400 mt-1.5">Archie runs locally on your machine...</p>
      </div>
    )
  },
  {
    ...
    type: 'whats-new',
    name: 'What\'s New',
    description: 'Latest updates and features in Archie',
    ...
    preview: (
      <div className="p-3 bg-gray-500/5 dark:bg-gray-300/5 rounded-lg">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium text-gray-900 dark:text-white">What's New in Archie</h3>
        </div>
