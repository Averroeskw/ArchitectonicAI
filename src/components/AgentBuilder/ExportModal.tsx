...
type ExportFormat = 'archie-native' | 'archie-sdk' | 'sdk-code';
...
const ExportModal: React.FC<ExportModalProps> = ({
  ...
  const [selectedFormat, setSelectedFormat] = useState<ExportFormat>('archie-sdk');
  ...
  const exportOptions: ExportOption[] = [
    {
      id: 'archie-native',
      name: 'Standard JSON',
      description: 'Classic Archie Agent Studio format for sharing and backup',
      icon: <FileText className="w-5 h-5" />,
      features: [
        'Compatible with all Archie versions',
        'Lightweight file size',
        'Easy to share and backup',
        'Standard JSON format'
      ],
      useCase: 'Best for sharing flows between Archie installations',
      fileExtension: '.json',
      color: 'blue',
    ...
    },
    {
      ...
      useCase: 'Perfect for running flows with the Archie SDK',
      fileExtension: '.json',
      color: 'green',
  ...
  const handleCopyInstallCommand = () => {
    if (selectedFormat === 'sdk-code') {
      navigator.clipboard.writeText('npm install archie-flow-sdk');
    }
  };
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex h-[600px]">
          ...
          <div className="w-1/2 p-6 border-r border-gray-200 dark:border-gray-700 overflow-y-auto">
            ...
            {hasCustomNodes && selectedFormat === 'archie-native' && (
