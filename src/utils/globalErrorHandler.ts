...
// Show a global error message overlay with Archie's theme
const showGlobalErrorMessage = (message: string) => {
  ...
  // Archie's mini avatar with actual image
  ...
  const archieImg = document.createElement('img');
  archieImg.src = '/mascot/Error_Archie.png';
  archieImg.alt = 'Archie Error Mascot';
  archieImg.style.cssText = `
    width: 100%;
    height: 100%;
    object-fit: contain;
  ...
  archieImg.onerror = () => {
    ...
    archieImg.src = '/src/assets/mascot/Error_Archie.png';
  };
  ...
  `;
  title.textContent = 'Archie needs your help!';
  ...
  button.style.cssText = `
    ...
    margin: 0 auto;
  `;
  button.innerHTML = '✨ Archie\'s Magic Refresh';
