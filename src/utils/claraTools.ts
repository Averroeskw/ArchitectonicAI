/**
 * Archie Assistant Tools System
 * 
 * This file defines the default tools available to Archie Assistant
 * and provides utilities for tool management and execution.
 */

import { ArchieTool, ArchieToolResult } from '../types/archie_assistant_types';

/**
 * Get current date and time
 */
const timeTools: ArchieTool[] = [
  {
    id: 'get_current_time',
 ...
 */
export const defaultTools: ArchieTool[] = [
  ...timeTools,
  ...mathTools,
  ...fileTools,
  ...systemTools
 ...
 * Get tool by ID
 */
export const getTool = (toolId: string): ArchieTool | undefined => {
 ...
 */
export const getToolsByCategory = (category: string): ArchieTool[] => {
 ...
 */
export const getEnabledTools = (): ArchieTool[] => {
  return defaultTools.filter(t => t.isEnabled);
};

/**
 * Convert Archie tools to OpenWebUI format for compatibility
 */
export const convertToOpenWebUIFormat = (tools: ArchieTool[]) => {
